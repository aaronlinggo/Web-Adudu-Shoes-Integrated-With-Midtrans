<?php
    ...
    if($action == "search") {
    ...
    else if($action == "showDetail_user"){
        $id_payment = $_REQUEST["id_payment"];
        ...
        <table class="table table-hover">
            <tbody class="dashboard_btn">
                ...
                <tr>
                    <td>Bank : <?= $payment_details['bank'] ?></td>
                </tr>
                <tr>
                    <td>Virtual Account Number : <?= $payment_details['va_number'] ?></td>
                </tr>
                <tr>
                    <td>Status : <?php 
                                if($payment_details['transaction_status'] == "settlement"){
                ...
                <tr>
                    <td>
                        <?php 
                            if($payment_details['bank'] == "bca"){
                                $link = "https://simulator.sandbox.midtrans.com/bca/va/index";
                            }
                            else if($payment_details['bank'] == "bri"){
                                $link = "https://simulator.sandbox.midtrans.com/bri/va/index";
                            }
                            else if($payment_details['bank'] == "bni"){
                                $link = "https://simulator.sandbox.midtrans.com/bni/va/index";
                            }
                        ?>
